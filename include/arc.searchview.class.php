...
class SearchView
{
    ...
    function GetPageListDM($list_len)
    {
        ...
        $infos = "<td>共<b>".$this->TotalResult."</b>条/显示<b>{$totalpage}</b>页 &nbsp;</td>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<td><a href='".$purl."PageNo=$prepagenum'>上一页</a></td>\r\n";
            $indexpage="<td><a href='".$purl."PageNo=1'>首页</a></td>\r\n";
        }
        else
        {
            $indexpage="<td>首页</td>\r\n";
        ...
        {
            $nextpage.="<td><a href='".$purl."PageNo=$nextpagenum'>下一页</a></td>\r\n";
            $endpage="<td><a href='".$purl."PageNo=$totalpage'>末页</a></td>\r\n";
        }
        else
        {
            $endpage="<td>末页</td>\r\n";
        ...
        {
            $plist.="<td><input type='text' name='PageNo' style='width:28px;height:14px' value='".$this->PageNo."' /></td>\r\n";
            $plist.="<td><input type='submit' name='plistgo' value='GO' style='width:30px;height:22px;font-size:9pt' /></td>\r\n";
        }
        $plist .= "</form>\r\n</tr>\r\n</table>\r\n";
        return $plist;
    }
